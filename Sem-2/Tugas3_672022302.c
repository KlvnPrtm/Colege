...
void InsertionSortFruit(struct TokoBuah *Toko, int n){
    ...
    for(int i = 0; i < n; i++){
        int j=i;
        strcpy(Huruf[i],Toko[i].Buah);
        strlwr(Huruf[i]);
    while(strcmp(Huruf[j-1],Huruf[j])>0){
...
//         for (int k = 0; Huruf[10][k]; k++){
//             Huruf[10][k]=tolower(Huruf[10][k]);
//         }
...
//             Huruf[k][k]=tolower(Huruf[k][k]);
//         }
//         for (int k = 0; Huruf1[k]; k++){

//             Huruf1[k]=tolower(Huruf1[k]);
//         }
//         if(strcmp(Huruf[i], Huruf1) == 0){
//             printf("Buah Ditemukan\n");
//             Found=1;
//             a++;
//         }
